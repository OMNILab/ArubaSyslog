...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description="Program to replay syslog over UDP.")
    parser.add_argument('--host', type=str, default="localhost",
        help="Receiver host name or IP address. Default: localhost")
    parser.add_argument('--port', type=int, default=54321,
        help="Receiver port. Default: 54321")
    parser.add_argument('--maxc', type=int, default=None,
        help="Maximum number of logs to be sent. Default: no limitation")
    parser.add_argument('--log', type=str, default=None,
        help="Log file name to reply")
